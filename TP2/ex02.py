...
for v in ['TIJUCA', "MARACANÃ", "MÉIER", "PIEDADE", "MADUREIRA", "PENHA", "RAMOS"]:
    grafo.adicionar_vertice(v)

arestas = [("TIJUCA", "MARACANÃ"), ("MARACANÃ", "MÉIER"), ("MÉIER", "PIEDADE"), ("PIEDADE", "MADUREIRA"), ("MADUREIRA", "PENHA"), ("PENHA", "RAMOS")]
...
grafo.mostrar_vizinhos("PIEDADE")